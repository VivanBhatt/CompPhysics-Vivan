...
def RK4(y, dt, parameters, istep):
# Numerical Recipes Equation 17.1.3
    t = istep * dt
    ...
    y3 = y + 0.5 * k2
    grad3 = calcGradients(y3, parameters)
    k3 = grad3 * dt
    
    y4 = y + k3
    grad4 = calcGradients(y4, parameters)
    k4 = grad4 * dt
...
def Stepper(y, dt, parameters, istep, stepperMethod):
    ...
    elif stepperMethod == 4:
        y, t, istep = RK4(y, dt, parameters, istep)
    return y, t, istep
